        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/admin/revenue">
                    ...
                    <span style="color: #6777ef;">Doanh Thu</span>
                </a>
            </li>
            <li class="nav-item">
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">Bán hàng (Tháng 2)
                                            </div>
                        ...
                        <!-- <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">Người Dùng Mới
                                                (Tháng 2)</div>
                        ...
                        <div class="col-xl-4 col-md-4 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">Yêu cầu đặt hàng
                                                (Tháng 2)</div>
                        ...
                        <div class="col-lg-8">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <code>adminAssets\js\demo\chart-bar-demo.js</code> file.
                                </div>
                            </div>
                        </div>
                        <!-- Donut Chart -->
