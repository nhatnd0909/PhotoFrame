            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Icon</h1>
                        <ol class="breadcrumb">
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">Tổng các Icon có
                                                sẵn
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">50 icon</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Danh Sách Các Icon</h6>
                            </div>
                                ...
                                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Gia đình</td>
                                            <td>2*3</td>
                                            <td>http://127.0.0.1:5501/admin/template</td>
                                            <td><a href="">http://127.0.0.1:5501/admin/template</a></td>
