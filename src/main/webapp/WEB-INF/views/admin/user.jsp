	...
	<div id="wrapper">
		...
		<ul class="navbar-nav sidebar sidebar-light accordion"
			...
			<li class="nav-item active"><a class="nav-link" href="user">
					<i class="fas fa-fw fa-user"></i> <span style="color: #6777ef;">Người
						Dùng</span>
			</a></li>
			<!--  -->
				...
				<div class="container-fluid" id="container-wrapper">
					<div
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Người
								dùng</li>
						</ol>
					</div>
									...
									<div class="row align-items-center">
										<div class="col mr-2">
											<div class="text-xs font-weight-bold text-uppercase mb-1">Tổng
												Người Dùng</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">${listCustommer.size()}
												người</div>
										</div>
										<div class="col-auto">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs font-weight-bold text-uppercase mb-1">Người
												dùng (Tháng 2)</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">650
												người</div>
						...
						<div class="col-xl-4 col-md-6 mb-4">
							<div class="card h-100">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs font-weight-bold text-uppercase mb-1">Lượt
												truy cập website</div>
											<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">366
												lượt</div>
											<div class="mt-2 mb-0 text-muted text-xs">
												<span class="text-success mr-2"><i
													class="fas fa-arrow-up"></i> 20.4%</span> <span>So với
													tháng trước</span>
											</div>
										</div>
										<div class="col-auto">
						...
						<div class="card mb-4">
							...
							<div class="table-responsive p-3">
								<table class="table align-items-center table-flush table-hover"
									...
									<tbody>
										<c:forEach var="customer" items="${listCustommer}">
											<tr>
												<td>${customer.name}</td>
												...
												<td><a href="" style="text-decoration: none;">Chi
														tiết</a></td>
											</tr>
										</c:forEach>
									</tbody>
