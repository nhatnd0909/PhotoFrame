...
<head>
  ...
  <link href="/adminAssets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
          ...
          <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    ...
                    Schờ xủ lý Alert: We've noticed unusually high schưa giải quyết for your account.
                  </div>
                </a>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <img class="img-profile rounded-circle" src="/adminAssets/img/boy.png" style="max-width: 60px">
                <span class="ml-2 d-none d-lg-inline text-white small">Sparkle Memo</span>
              </a>
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row mb-3">
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Doanh Thu (Tháng 02)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">40,000 Đ</div>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Bán hàng (Tháng 2)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">650 sản phẩm</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Người Dùng Mới (Tháng 2)</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Yêu cầu đặt hàng (Tháng 2)</div>
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Sản phẩm đã bán (Tháng 2)</h6>
                </div>
                <div class="card-body">
                  <div class="mb-3">
                    <div class="small text-gray-500">Photo Frame
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Rivat Mahesa</td>
                        <td>Photo Frame</td>
                        <td><span class="badge badge-danger">chưa giải quyết</span></td>
                        <td><a href="#" class="btn btn-sm btn-primary">Detail</a></td>
                      </tr>
                      <tr>
