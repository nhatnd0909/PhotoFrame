                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class=""><a href="detail-template" class="active">Dịch vụ</a></li>
    ...
    <div class="container-fluid py-5 mt-5">
        <div class="container py-5">
            <div style="margin-bottom: 100px;margin-top: 50px;">
                <h1 class="fw-bold mb-0" style="color: #FF9999 !important;">Chi tiết đặt hàng</h1>
            </div>
            ...
            <div class="container d-lg-flex d-flex justify-content-center">
                <div class="box-1 bg-light user">
                    <div class="d-flex align-items-center mb-3">
                        <img src="assets/images/avatar.webp" class="pic rounded-circle" alt="">
                        <p class="ps-2 name">Username</p>
                    </div>
                    <div class="box-inner-1 pb-3 mb-3 ">
                        <div class="d-flex justify-content-between mb-3 userdetails">
                            <p class="fw-bold">Khung tranh 1</p>
                            <p class="fw-lighter"><span class="fas fa-dollar-sign"></span>180.00đ</p>
                        </div>
                        <div id="my">
                        ...
                        <p class="dis info my-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate
                            quos ipsa
                            sed officiis odio
                        </p>
                        <!-- <div class="radiobtn">
                ...
                <div class="box-2">
                    <div class="box-inner-2">
                        <div>
                            ...
                            <p class="dis mb-3">Hoàn tất giao dịch mua hàng của bạn bằng cách cung cấp chi tiết thanh
                                toán của bạn</p>
                        </div>
                        <form action="">
                            <div class="mb-3">
                            ...
                            <div>
                                <div class="address">
                                    ...
                                    <div class="d-flex flex-column dis">
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            <p>Tổng đơn hàng</p>
                                            <p><span class="fas fa-dollar-sign"></span>180.000đ</p>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            <p>Giảm giá<span>(20%)</span></p>
                                            <p><span class="fas fa-dollar-sign"></span>36,000đ</p>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            <p class="fw-bold">Total</p>
                                            <p class="fw-bold"><span class="fas fa-dollar-sign"></span>144.000đ</p>
                                        </div>
                                        <div class="btn btn-primary mt-2">Thanh
                                            toán<span class="fas fa-dollar-sign px-1"></span>144.000đ
                                        </div>
                                    </div>
                                </div>
                            </div>
