					...
					<div class="row g-4">
						...
						<form action="">
							...
							<div class="col-lg-12">
											...
											<div class="row g-4">
												<div class="row" style="margin-top: 50px;">
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon1" class="img-container"
																onclick="toggleCheckbox('icon1')"> <input
																type="checkbox" id="icon1" name="icon" value="1" hidden>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon2" class="img-container"
																onclick="toggleCheckbox('icon2')"> <input
																type="checkbox" id="icon2" name="icon" value="2" hidden>
																<img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon3" class="img-container"
																onclick="toggleCheckbox('icon3')"> <input
																type="checkbox" id="icon3" name="icon" value="3" hidden>
																<img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon4" class="img-container"
																onclick="toggleCheckbox('icon4')"> <input
																type="checkbox" id="icon4" name="icon" value="4" hidden>
																<img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon5" class="img-container"
																onclick="toggleCheckbox('icon5')"> <input
																type="checkbox" id="icon5" name="icon" value="5" hidden>
																<img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon5" class="img-container"
																onclick="toggleCheckbox('icon6')"> <input
																type="checkbox" id="icon6" name="icon" value="6" hidden>
																<img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon5" class="img-container"
																onclick="toggleCheckbox('icon7')"> <input
																type="checkbox" id="icon7" name="icon" value="7" hidden>
																<img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon5" class="img-container"
																onclick="toggleCheckbox('icon8')"> <input
																type="checkbox" id="icon8" name="icon" value="8" hidden>
																<img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon5" class="img-container"
																onclick="toggleCheckbox('icon9')"> <input
																type="checkbox" id="icon9" name="icon" value="9" hidden>
																<img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon10" class="img-container"
																onclick="toggleCheckbox('icon10')"> <input
																type="checkbox" id="icon10" name="icon" value="10"
																hidden> <img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													</div>
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon11" class="img-container"
																onclick="toggleCheckbox('icon11')"> <input
																type="checkbox" id="icon11" name="icon" value="11"
																hidden> <img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
													...
													<div class="col-lg-2 col-sm-3" style="margin-bottom: 20px;">
														<div class="border rounded">
															<label for="icon12" class="img-container"
																onclick="toggleCheckbox('icon12')"> <input
																type="checkbox" id="icon12" name="icon" value="12"
																hidden> <img src="assets/images/template1.png"
																class="img-fluid rounded" alt="Image">
															</label>
														</div>
								...
								<!-- <button class="btn border border-secondary rounded-pill px-5 py-3 mb-5 text-primary">Đặt
                                    Hàng</button> -->
								<a href="payment"
