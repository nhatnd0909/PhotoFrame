      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="header-text">
            ...
            <h2>Nơi Để <em>Thiết Kế</em> <br> Ý Tưởng Của Bạn!</h2>
            <!-- <h2>Best Place To <em>Design</em> Your <br> Ideas!</h2> -->
            <div class="main-button-gradient">
              <div class="scroll-to-section"><a href="#contact-section">Thiết kế ngay!</a></div>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading">
            ...
            <h4><em>Sản Phẩm</em> Của Chúng Tôi</h4>
          </div>
        </div>
        <div class="col-lg-12">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            <h6>Dịch Vụ</h6>
            <h4>Những Thứ Bạn Có Thể<em> Làm</em></h4>
            <p>You just think about Result whenever you need free templates for your idea will do it</p>
          </div>
        </div>
        <div class="col-lg-12">
          <div class="naccs">
            <div class="tabs">
              <div class="row">
                <div class="col-lg-3">
                  <div class="menu">
                    <div class="active gradient-border"><span>Gia Đình</span></div>
                    <div class="gradient-border"><span>Người Yêu</span></div>
                    <div class="gradient-border"><span>Bạn Bè</span></div>
                    <div class="gradient-border"><span>Bản Thân</span></div>
                  </div>
                </div>
                <div class="col-lg-9">
                  <ul class="nacc">
                    <li class="active">
                      <div>
                        ...
                        <div class="right-content">
                          ...
                          <p>Did you know that you can visit <a rel="nofollow" href="https://www.toocss.com/"
                              target="_blank">TooCSS website</a> for latest listing of HTML templates and a variety of
                            useful templates.
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading">
            <h6>NHẬN XÉT</h6>
            <h4>Nhận Xét Từ <em>Khách Hàng</em></h4>
          </div>
        </div>
        <div class="col-lg-12">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="section-heading">
                  ...
                  <p>Nếu bạn có ý kiến muốn phản hồi hãy để lại nội dung ở mẫu dưới đây</p>
                </div>
              </div>
              <div class="col-lg-12">
                <fieldset>
